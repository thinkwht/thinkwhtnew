      ...
      <footer className={props.className}>
        <div className="flex flex-col items-center justify-center w-full">
          ...
          >
            ...
            <div className="absolute h-[1003px] inset-y-[0] left-[0] my-auto w-[36%] sm:w-full">
              <div className="h-[1003px] m-auto w-full">
                <Img
                  ...
                  src="images/img_4799d32e64cad76_1003x507.png"
                  alt="4799d32e64cadSeventySix"
                />
                <div className="absolute bg-blue_gray-700 bottom-[3%] flex flex-col items-end justify-end left-[10%] p-[9px] rounded-[10px]">
                  <Text
            ...
            <div className="absolute bottom-[5%] flex md:flex-col flex-row md:gap-10 items-start justify-between right-[3%] w-[59%]">
              <Text
                className="md:mt-0 mt-0.5 text-sm text-white-A700"
                size="txtInterSemiBold14"
              >
                Copyright © 2023 ELVDRIVE Scooter LLP - All rights reserved.
              </Text>
              <Text
                className="mb-0.5 text-sm text-white-A700"
                size="txtInterSemiBold14"
              >
                Developed by ELVDRIVE Labs{" "}
              </Text>
            </div>
            <Line className="absolute bg-white-A700_7f bottom-[11%] h-px right-[0] w-[65%]" />
          </div>
        </div>
      </footer>
    </>
