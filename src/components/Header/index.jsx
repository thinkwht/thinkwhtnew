  ...
  return (
    <>
      <header className={props.className}>
        <div className="flex md:flex-col flex-row md:gap-[55px] items-center justify-between mx-auto my-1.5 w-[96%]">
          ...
          <div className="bg-orange-300 flex flex-row gap-[21px] items-center justify-evenly mb-[17px] md:mt-0 mt-6 p-[11px] rounded-[10px] w-[11%] md:w-full">
            <Img className="h-7" src="images/img_group.svg" alt="group" />
            <Text
