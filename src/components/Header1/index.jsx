  ...
  return (
    <>
      <header className={props.className}>
        <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between md:ml-[0] ml-[33px] mr-[62px] my-1.5 w-[94%]">
          ...
          <Input
            ...
            className="!placeholder:text-blue_gray-700 !text-blue_gray-700 font-inter font-medium leading-[normal] p-0 sm:hidden text-base text-center w-full"
            wrapClassName="flex sm:hidden md:mt-0 my-[23px] rounded-[23px] md:w-full"
            prefix={
              <div className="h-4 mt-px mb-0.5 mr-[19px] sm:hidden w-4 bg-orange-300">
                <Img
                  className="cursor-pointer h-4 sm:hidden my-auto"
          ...
          <div className="bg-orange-300 flex flex-col sm:hidden items-center justify-start md:mt-0 my-[7px] pb-[5px] rounded-[38px]">
            <Img
