      ...
      <div className="bg-white-A700 font-inter h-[12386px] mx-auto relative w-full">
        <div className="absolute flex flex-col inset-x-[0] items-center justify-start mx-auto top-[0] w-full">
          ...
          <div className="md:h-[796px] h-[850px] md:px-5 relative w-full">
            ...
            <div
              className="absolute bg-cover bg-no-repeat flex flex-row font-lato h-[796px] inset-x-[0] items-center justify-start mx-auto p-[69px] md:px-10 sm:px-5 rounded-[10px] top-[0] w-full"
              style={{ backgroundImage: "url('images/img_group601.png')" }}
            >
              <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start mb-[27px] ml-[22px] w-[95%]">
                <div className="h-[631px] relative w-[63%] md:w-full">
                  <div className="backdrop-opacity-[0.5] bg-white-A700_87 blur-[500.00px] h-[372px] mt-14 mx-auto rounded-[202px] w-[53%]"></div>
                  <Img
                    className="absolute h-[631px] inset-[0] justify-center m-auto object-cover w-full"
                    src="images/img_16bed5a8554a241.png"
                    alt="16bed5a8554a241"
                  />
                </div>
                <Text
                  className="ml-1 md:ml-[0] md:mt-0 mt-[428px] sm:text-[40px] md:text-[46px] text-[50px] text-blue_gray-700 w-[38%] sm:w-full"
                  size="txtLatoBlack50"
                >
          ...
          <Text
            className="mt-[82px] md:text-3xl sm:text-[28px] text-[32px] text-blue_gray-400 text-justify w-[93%] sm:w-full"
            size="txtInterRegular32"
          >
            React.js, commonly referred to as React, is a popular and powerful
            JavaScript library for building user interfaces. Developed and
            maintained by Facebook and a community of individual developers,
            React.js has gained widespread adoption due to its simplicity,
            efficiency, and component-based architecture.
          </Text>
          <div className="bg-orange-200_01 flex flex-col items-center justify-start max-w-[1373px] mt-[382px] p-[217px] md:px-5 rounded-[10px] w-full">
          ...
          <div className="bg-blue-800_01 flex flex-row items-center justify-start max-w-[1358px] mt-[136px] p-7 md:px-5 shadow-bs7 w-full">
          ...
          <Button
            className="cursor-pointer font-medium leading-[normal] min-w-[526px] sm:min-w-full mt-[172px] rounded-[20px] text-5xl sm:text-[38px] md:text-[44px] text-center"
            color="blue_gray_700"
            size="xl"
            variant="fill"
          >
        ...
        <div className="absolute bottom-[0] flex flex-col inset-x-[0] justify-start mx-auto w-full">
          ...
          <div className="flex md:flex-col flex-row font-inter gap-[34px] items-start justify-end md:ml-[0] ml-[168px] mt-[76px] md:px-5 w-[88%] md:w-full">
            <div className="md:h-[1781px] h-[1794px] md:mt-0 mt-3 relative w-[3%] md:w-full">
            ...
            <div className="flex flex-col items-start justify-start w-[95%] md:w-full">
              ...
              <Text
                className="md:ml-[0] ml-[338px] text-black-900_a0 text-xl w-[53%] sm:w-full"
              ...
              <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between mt-[68px] w-[68%] md:w-full">
                <Text
                  className="text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
              ...
              <Text
                className="md:ml-[0] ml-[338px] mt-0.5 text-black-900_a0 text-xl w-[53%] sm:w-full"
                size="txtInterRegular20Black900a0"
              >
                We are a technology company on a mission to equip students with
                relevant skills & practical exposure to help them get the best
              ...
              <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between mt-16 w-[82%] md:w-full">
                <Text
                  className="md:mt-0 mt-1.5 text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
                  Class 3.
                </Text>
              ...
              <div className="flex md:flex-col flex-row md:gap-10 items-end justify-between mt-[94px] w-[74%] md:w-full">
                <Text
                  className="text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
              ...
              <Text
                className="md:ml-[0] ml-[338px] mt-2 text-black-900_a0 text-xl w-[53%] sm:w-full"
                size="txtInterRegular20Black900a0"
              >
                We are a technology company on a mission to equip students with
                relevant skills & practical exposure to help them get the best
              ...
              <div className="flex sm:flex-col flex-row sm:gap-10 items-center justify-between mt-16 w-1/2 md:w-full">
                <Text
                  className="text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
              ...
              <Text
                className="md:ml-[0] ml-[334px] mt-[7px] text-black-900_a0 text-xl w-[53%] sm:w-full"
                size="txtInterRegular20Black900a0"
              >
                We are a technology company on a mission to equip students with
                relevant skills & practical exposure to help them get the best
              ...
              <div className="flex md:flex-col flex-row md:gap-10 items-end justify-between ml-0.5 md:ml-[0] mt-[65px] w-3/4 md:w-full">
                <Text
                  className="text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
              ...
              <Text
                className="md:ml-[0] ml-[338px] mt-[17px] text-black-900_a0 text-xl w-[53%] sm:w-full"
                size="txtInterRegular20Black900a0"
              >
                We are a technology company on a mission to equip students with
                relevant skills & practical exposure to help them get the best
              ...
              <div className="flex sm:flex-col flex-row md:gap-10 items-start justify-between ml-0.5 md:ml-[0] mt-[51px] w-full">
                <Text
                  className="sm:mt-0 mt-6 text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
                  Class 7.
                </Text>
                <Text
                  ...
                  size="txtInterMedium40Blue80001"
                >
                  API Integration & Asynochronus Operations
                </Text>
              </div>
              <Text
                className="md:ml-[0] ml-[338px] mt-[18px] text-black-900_a0 text-xl w-[53%] sm:w-full"
                size="txtInterRegular20Black900a0"
              >
                We are a technology company on a mission to equip students with
                relevant skills & practical exposure to help them get the best
              ...
              <div className="flex sm:flex-col flex-row sm:gap-10 items-end justify-between ml-0.5 md:ml-[0] mt-2 w-[49%] md:w-full">
                <Text
                  className="text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
              ...
              <Text
                className="md:ml-[0] ml-[338px] mt-[9px] text-black-900_a0 text-xl w-[53%] sm:w-full"
                size="txtInterRegular20Black900a0"
              >
                We are a technology company on a mission to equip students with
                relevant skills & practical exposure to help them get the best
          ...
          />
          <PagerIndicator
            className="flex h-3.5 justify-center md:ml-[0] ml-[664px] mt-[90px] w-[126px]"
            count={4}
          ...
          />
          <Text
            className="md:ml-[0] ml-[336px] mt-[116px] md:text-5xl text-[64px] text-blue-800 text-center"
          ...
          <Footer3 className="flex font-inter items-center justify-center mt-[133px] md:px-5 w-full" />
        </div>
...
export default ReactJSpagePage;
