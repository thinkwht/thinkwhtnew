...
const JavapagePage = () => {
  ...
  return (
    <>
      <div className="bg-white-A700 font-inter h-[12373px] mx-auto relative w-full">
        <div className="absolute flex flex-col inset-x-[0] items-center justify-start mx-auto top-[0] w-full">
          <Header3 className="flex flex-col items-center justify-center md:px-5 w-full" />
          <div className="md:h-[732px] h-[854px] md:px-5 relative w-full">
            <Text
            ...
            <div
              className="absolute bg-cover bg-no-repeat font-lato md:h-[732px] h-[796px] inset-x-[0] mx-auto p-1 rounded-[10px] top-[0] w-full"
              style={{ backgroundImage: "url('images/img_group601.png')" }}
            >
              <div className="absolute bottom-[1%] h-[732px] inset-x-[0] mx-auto w-[86%] md:w-full">
                <div className="absolute flex flex-col items-center justify-start right-[0] top-[9%] w-[86%]">
                ...
                <Img
                  className="absolute h-[732px] inset-y-[0] left-[0] my-auto object-cover w-[66%]"
                  src="images/img_c49b39335554051.png"
                  alt="c49b39335554051"
                />
              </div>
            </div>
          ...
          <Text
            className="mt-[319px] md:text-3xl sm:text-[28px] text-[32px] text-blue_gray-400 text-justify w-[92%] sm:w-full"
            size="txtInterRegular32"
          >
            The combination of Java and DSA allows developers to implement
            efficient and optimized solutions for real-world problems. By
            leveraging the robust features of Java, such as its extensive
            standard library, developers can work with data structures and
            algorithms to design high-performance applications.
          </Text>
          <div className="bg-orange-200_01 flex flex-col items-center justify-start max-w-[1373px] mt-[123px] p-[217px] md:px-5 rounded-[10px] w-full">
          ...
          <div className="bg-blue-800_01 flex flex-row items-center justify-start max-w-[1358px] mt-[148px] p-7 md:px-5 shadow-bs7 w-full">
          ...
          <Button
            className="cursor-pointer font-medium leading-[normal] min-w-[526px] sm:min-w-full mt-[168px] rounded-[20px] text-5xl sm:text-[38px] md:text-[44px] text-center"
            color="blue_gray_700"
            size="xl"
            variant="fill"
          >
        ...
        <div className="absolute bottom-[0] flex flex-col inset-x-[0] justify-start mx-auto w-full">
          ...
          <div className="flex md:flex-col flex-row font-inter gap-[34px] items-start justify-start md:ml-[0] ml-[168px] mt-[76px] md:px-5 w-[72%] md:w-full">
            <div className="md:h-[1781px] h-[1794px] md:mt-0 mt-3 relative w-[4%] md:w-full">
            ...
            <div className="flex flex-col items-start justify-start w-[94%] md:w-full">
              ...
              <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between mt-[68px] w-[97%] md:w-full">
                <Text
                  className="text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
              ...
              <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between mt-[54px] w-[87%] md:w-full">
                <Text
                  className="md:mt-0 mt-[17px] text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
                  Class 3.
                </Text>
              ...
              <Text
                className="md:ml-[0] ml-[338px] mt-[7px] text-black-900_a0 text-xl w-[66%] sm:w-full"
                size="txtInterRegular20Black900a0"
              >
                We are a technology company on a mission to equip students with
                relevant skills & practical exposure to help them get the best
              ...
              <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between mt-[31px] w-[93%] md:w-full">
                <Text
                  className="text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
              ...
              <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between mt-16 w-[99%] md:w-full">
                <Text
                  className="text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
              ...
              <div className="flex sm:flex-col flex-row sm:gap-10 items-end justify-between ml-0.5 md:ml-[0] mt-[85px] w-[71%] md:w-full">
                <Text
                  className="text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
              ...
              <div className="flex sm:flex-col flex-row sm:gap-10 items-end justify-between ml-0.5 md:ml-[0] mt-[61px] w-3/5 md:w-full">
                <Text
                  className="text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
          ...
          />
          <Text
            className="md:ml-[0] ml-[334px] mt-32 md:text-5xl text-[64px] text-blue-800 text-center"
            size="txtInterBold64Blue800"
          >
            Certificate We Offer You
          </Text>
          <Text
            className="md:ml-[0] ml-[404px] mt-[19px] text-2xl md:text-[22px] text-blue_gray-400 sm:text-xl"
            size="txtPoppinsMedium24Bluegray400"
          >
            Lorem Ipsum is simply dummy text of the printing.
          </Text>
          <div className="bg-blue_gray-100_02 h-[574px] max-w-[1257px] md:ml-[0] ml-[89px] mr-[94px] mt-[87px] md:px-5 w-full"></div>
          <Footer1 className="flex font-inter items-center justify-center mt-[132px] md:px-5 w-full" />
        </div>
