      ...
      <div className="bg-white-A700 font-inter h-[12364px] mx-auto relative w-full">
        <div className="absolute flex flex-col inset-x-[0] items-center justify-start mx-auto top-[0] w-full">
          ...
          <div className="md:h-[796px] h-[850px] md:px-5 relative w-full">
            ...
            <div
              className="absolute bg-cover bg-no-repeat flex flex-row font-lato h-[796px] inset-x-[0] items-center justify-start mx-auto md:pr-10 sm:pr-5 pr-[74px] py-[74px] rounded-[10px] top-[0] w-full"
              style={{ backgroundImage: "url('images/img_group601.png')" }}
            >
              <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between mb-[51px] w-[98%]">
                <div className="h-[597px] relative w-3/5 md:w-full">
                  <div className="backdrop-opacity-[0.5] bg-white-A700_87 blur-[500.00px] h-[372px] ml-auto mr-[113px] mt-[51px] rounded-[202px] w-[51%]"></div>
                  <Img
                    className="absolute h-[597px] inset-[0] justify-center m-auto object-cover w-full"
                    src="images/img_96db7e182785f18.png"
                    alt="96db7e182785fEighteen"
                  />
                </div>
                <Text
                  className="md:mt-0 mt-[423px] sm:text-[40px] md:text-[46px] text-[50px] text-blue_gray-700"
                  size="txtLatoBlack50"
                >
          ...
          <div className="bg-orange-200_01 flex flex-col items-center justify-start max-w-[1373px] mt-[625px] p-[217px] md:px-5 rounded-[10px] w-full">
          ...
          <div className="bg-blue-800_01 flex flex-row items-center justify-start max-w-[1358px] mt-[132px] p-7 md:px-5 shadow-bs7 w-full">
          ...
          <Button
            className="cursor-pointer font-medium leading-[normal] min-w-[526px] sm:min-w-full mt-[164px] rounded-[20px] text-5xl sm:text-[38px] md:text-[44px] text-center"
            color="blue_gray_700"
            size="xl"
            variant="fill"
          >
        ...
        <div className="absolute bottom-[0] flex flex-col inset-x-[0] justify-start mx-auto w-full">
          ...
          <div className="flex md:flex-col flex-row font-inter gap-[34px] items-start justify-start max-w-[1075px] md:ml-[0] ml-[168px] mt-[78px] md:px-5 w-full">
            ...
            <div className="flex md:flex-1 flex-col items-start justify-start w-[94%] md:w-full">
              ...
              <div className="flex sm:flex-col flex-row sm:gap-10 items-start justify-between mt-[68px] w-[72%] md:w-full">
                <Text
                  className="text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
              ...
              <div className="flex sm:flex-col flex-row sm:gap-10 items-end justify-between mt-[71px] w-[68%] md:w-full">
                <Text
                  className="text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
              ...
              <div className="flex md:flex-col flex-row md:gap-10 items-end justify-between mt-[79px] w-[78%] md:w-full">
                <Text
                  className="text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
              ...
              <div className="flex md:flex-col flex-row md:gap-10 items-end justify-between mt-16 w-[77%] md:w-full">
                <Text
                  className="text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
              ...
              <div className="flex md:flex-col flex-row md:gap-10 items-end justify-between ml-0.5 md:ml-[0] mt-[65px] w-[89%] md:w-full">
                <Text
                  className="text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
              ...
              <div className="flex sm:flex-col flex-row sm:gap-10 items-end justify-between ml-0.5 md:ml-[0] mt-[75px] w-full">
                <Text
                  className="text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
              ...
              <div className="flex sm:flex-col flex-row sm:gap-10 items-end justify-between ml-0.5 md:ml-[0] mt-[61px] w-[58%] md:w-full">
                <Text
                  className="text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
              ...
              <Text
                className="md:ml-[0] ml-[338px] mt-[9px] text-black-900_a0 text-xl w-[63%] sm:w-full"
                size="txtInterRegular20Black900a0"
              >
                We are a technology company on a mission to equip students with
                relevant skills & practical exposure to help them get the best
          ...
          <div className="flex md:flex-col flex-row font-inter gap-2 items-start justify-start md:ml-[0] ml-[63px] mt-[116px] md:px-5 w-[86%] md:w-full">
            ...
            <div className="flex flex-col md:gap-10 gap-[187px] justify-start md:mt-0 mt-[46px] w-[53%] md:w-full">
          ...
          <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between max-w-[1134px] ml-11 md:ml-[0] mt-[50px] md:px-5 w-full">
            <div className="flex md:flex-1 flex-col md:gap-10 gap-[181px] justify-start md:mt-0 mt-[301px] w-[8%] md:w-full">
              <Img
                className="h-[27px] md:h-auto md:ml-[0] ml-[39px] object-cover w-7 sm:w-full"
          ...
          />
          <PagerIndicator
            className="flex h-3.5 justify-center md:ml-[0] ml-[664px] mt-[88px] w-[126px]"
            count={4}
          ...
          />
          <Text
            className="md:ml-[0] ml-[338px] mt-28 md:text-5xl text-[64px] text-blue-800 text-center"
          ...
          <Footer1 className="flex font-inter items-center justify-center mt-[106px] md:px-5 w-full" />
        </div>
...
export default GoogleCloudpagePage;
