    ...
    <>
      <div className="bg-white-A700 flex flex-col items-center justify-start mx-auto w-full">
        <div className="flex flex-col justify-start w-full">
          ...
          <div className="bg-gradient21  font-inter md:h-[750px] h-[765px] pl-[15px] pt-[15px] md:px-5 relative w-full">
            <div className="h-[750px] m-auto w-[97%] md:w-full">
              <div className="absolute bottom-[0] flex flex-col inset-x-[0] mx-auto w-full">
                <div className="md:h-[385px] h-[558px] mx-auto w-full">
                  <Text
                    className="absolute capitalize leading-[86.00px] left-[0] md:text-5xl text-[64px] text-gray-900_12 top-[0] w-[53%] sm:w-full"
                  ...
                  <Text
                    className="absolute bottom-[28%] capitalize leading-[29.00px] left-[0] text-[19.2px] text-gray-900_12 w-[48%] sm:w-full"
                    size="txtInterRegular192"
                  >
                    Suspendisse potenti. In eget augue egestas, gravida libero
                    eu, luctus ipsum. Aliquam non pulvinar ex.
                  </Text>
                  <div
                    className="absolute bg-cover bg-no-repeat bottom-[0] flex flex-col h-[388px] items-start justify-start p-[33px] sm:px-5 right-[0] w-[52%]"
                    style={{
                      backgroundImage: "url('images/img_group1370.png')",
                    }}
                  >
                    <Img
                      className="h-[164px] mb-[151px] mt-1"
                      src="images/img_vector1_red_a200.svg"
                      alt="vectorOne"
                    />
                  </div>
                </div>
                <Img
                  className="h-[124px] ml-[494px] mt-[-25.88px] z-[1]"
                  src="images/img_spiral1.svg"
                  alt="spiralOne"
                />
              </div>
              <div className="absolute h-[750px] inset-y-[0] my-auto right-[1%] w-[51%] md:w-full">
                <Img
                  className="h-[750px] m-auto object-cover w-full"
                  src="images/img_excitedbrunett_750x695.png"
                  alt="excitedbrunett"
                />
                <div className="absolute flex flex-col gap-[53px] justify-start right-[8%] top-[33%] w-[42%]">
                  <Img
                    className="h-[67px] md:ml-[0] ml-[72px]"
                    src="images/img_info_cyan_900_01.svg"
                    alt="info_One"
                  />
                  <div
                    className="bg-cover bg-no-repeat flex flex-col h-[86px] items-center justify-start p-2.5 w-full"
                    style={{ backgroundImage: "url('images/img_group24.svg')" }}
                  >
                    <div className="flex flex-row gap-[27px] items-center justify-between mb-4 w-[96%] md:w-full">
                      <Text
                        className="capitalize leading-[24.00px] text-base text-gray-900_12"
                        size="txtInterRegular16Gray90012"
                      >
                        gravida libero eu, luctus ipsum. Aliquam
                      </Text>
                      <Img
            ...
            <Button
              className="bottom-[18%] cursor-pointer flex items-center justify-center left-[4%] mb-[141px] min-w-[211px] ml-10 rounded-[30px]"
              leftIcon={
                <Img
            ...
            <div
              className="absolute bg-cover bg-no-repeat bottom-[4%] flex flex-col h-[86px] items-center justify-start p-2.5 right-[29%] w-1/4"
              style={{ backgroundImage: "url('images/img_group1371.svg')" }}
            >
              <div className="flex flex-row gap-4 items-center justify-start mb-4 w-[98%] md:w-full">
                <Img
                  className="h-[50px] md:h-auto rounded-[50%] w-[50px]"
                ...
                />
                <Text
                  className="capitalize leading-[24.00px] text-base text-white-A700 w-4/5 sm:w-full"
                  size="txtInterRegular16WhiteA700"
                >
                  gravida libero eu, luctus ipsum. Aliquam non pulvinar ex.
                </Text>
              </div>
            </div>
          </div>
          <Text
            className="md:ml-[0] ml-[644px] mt-[57px] text-5xl sm:text-[38px] md:text-[44px] text-blue_gray-900_05 text-center"
