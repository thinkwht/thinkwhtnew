...
const AngularJSpagePage = () => {
  ...
  return (
    <>
      <div className="bg-white-A700 font-inter h-[12364px] mx-auto relative w-full">
        <div className="absolute flex flex-col inset-x-[0] items-center justify-start mx-auto top-[0] w-full">
          <Header3 className="flex flex-col items-center justify-center md:px-5 w-full" />
          <div
            className="bg-cover bg-no-repeat flex flex-row font-lato h-[796px] items-center justify-start p-[50px] md:px-10 sm:px-5 rounded-[10px] w-full"
            style={{ backgroundImage: "url('images/img_group601.png')" }}
          >
            <div className="flex md:flex-col flex-row gap-[34px] items-start justify-start ml-5 mt-[5px] w-[94%]">
              <div className="h-[691px] relative w-[61%] md:w-full">
                <div className="backdrop-opacity-[0.5] bg-white-A700_87 blur-[500.00px] h-[372px] ml-auto mr-[151px] mt-[70px] rounded-[202px] w-[54%]"></div>
                <Img
                  className="absolute h-[691px] inset-[0] justify-center m-auto object-cover w-full"
                  src="images/img_10b0fbdbf4a39d0.png"
                  alt="10b0fbdbf4a39dZero"
                />
              </div>
              <Text
                className="md:mt-0 mt-[442px] sm:text-[40px] md:text-[46px] text-[50px] text-blue_gray-700 w-[37%] sm:w-full"
                size="txtLatoBlack50"
              >
          ...
          <Text
            className="mt-2.5 text-5xl sm:text-[38px] md:text-[44px] text-blue_gray-900_05 text-center"
            size="txtInterBlack48"
          >
            About
          </Text>
          <Text
            className="mt-[308px] md:text-3xl sm:text-[28px] text-[32px] text-blue_gray-400 text-justify w-[91%] sm:w-full"
            size="txtInterRegular32"
          >
            AngularJS follows the Model-View-Controller (MVC) design pattern,
            which helps to maintain a clear separation of concerns within the
            application. The model represents the data and business logic, the
            view is responsible for displaying the user interface, and the
            controller acts as an intermediary, handling user input and updating
            the model and view accordingly.
          </Text>
          <div className="flex flex-col font-inter md:gap-10 gap-[124px] items-center justify-start max-w-[1374px] mt-[94px] md:px-5 w-full">
            <div className="bg-orange-200_01 flex flex-col items-center justify-start p-[216px] md:px-10 sm:px-5 rounded-[10px] w-full">
            ...
            <div className="bg-blue-800_01 flex flex-row items-center justify-start p-7 sm:px-5 shadow-bs7 w-[99%] md:w-full">
          ...
          <Button
            className="cursor-pointer font-medium leading-[normal] min-w-[526px] sm:min-w-full mt-[155px] rounded-[20px] text-5xl sm:text-[38px] md:text-[44px] text-center"
            color="blue_gray_700"
            size="xl"
            variant="fill"
          >
        ...
        <div className="absolute h-[474px] left-[8%] md:px-5 top-[27%] w-[37%] sm:w-full">
          <div className="absolute backdrop-opacity-[0.5] bg-orange-300 blur-[500.00px] bottom-[4%] h-[265px] left-[0] rounded-[132px] w-1/2"></div>
          <Img
            className="absolute h-[474px] inset-y-[0] my-auto object-cover right-[0] w-[90%]"
        ...
        <div className="absolute bottom-[0] flex flex-col inset-x-[0] justify-start mx-auto w-full">
          ...
          <div className="font-inter h-[1120px] md:h-[1141px] sm:h-[1577px] mt-[146px] md:px-5 relative w-full">
            <div className="absolute h-[1048px] sm:h-[1431px] md:h-[995px] inset-x-[0] mx-auto top-[0] w-full">
              <div className="h-[1048px] sm:h-[1431px] md:h-[995px] m-auto w-full">
                <div className="flex flex-col md:gap-10 gap-[540px] h-full items-center justify-start m-auto w-full">
                  <div className="h-[504px] md:h-[840px] sm:h-[888px] relative w-[78%] md:w-full">
                    <div className="h-[504px] md:h-[840px] sm:h-[888px] m-auto w-full">
                      <div className="absolute h-[471px] md:h-[840px] sm:h-[888px] inset-x-[0] mx-auto top-[0] w-full">
                        <div className="absolute bottom-[0] h-[436px] md:h-[840px] sm:h-[888px] inset-x-[0] mx-auto w-full">
                          <div className="flex flex-col h-full items-center justify-start m-auto w-full">
                            ...
                            >
                              ...
                              <div className="flex flex-1 flex-col md:gap-10 gap-[72px] items-center justify-start sm:ml-[0] w-full">
              ...
              <Img
                className="absolute bottom-[11%] h-[198px] left-[34%]"
          ...
          <div className="flex md:flex-col flex-row font-inter gap-[34px] items-start justify-start max-w-[1119px] md:ml-[0] ml-[168px] mt-[78px] md:px-5 w-full">
            ...
            <div className="flex md:flex-1 flex-col items-start justify-start w-[94%] md:w-full">
              ...
              <Text
                className="md:ml-[0] ml-[338px] text-black-900_a0 text-xl w-3/5 sm:w-full"
              ...
              <div className="flex sm:flex-col flex-row sm:gap-10 items-start justify-between mt-[68px] w-[61%] md:w-full">
                <Text
                  className="text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
                ...
                <Text
                  className="sm:mt-0 mt-0.5 sm:text-4xl md:text-[38px] text-[40px] text-blue-800_01 tracking-[0.80px]"
              ...
              <Text
                className="md:ml-[0] ml-[338px] mt-0.5 text-black-900_a0 text-xl w-3/5 sm:w-full"
                size="txtInterRegular20Black900a0"
              >
                We are a technology company on a mission to equip students with
                relevant skills & practical exposure to help them get the best
              ...
              <div className="flex sm:flex-col flex-row md:gap-10 items-start justify-between mt-[54px] w-full">
                <Text
                  className="sm:mt-0 mt-[17px] text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
                  Class 3.
                </Text>
                <Text
                  className="leading-[156.50%] sm:text-4xl md:text-[38px] text-[40px] text-blue-800_01 tracking-[0.80px]"
                  size="txtInterMedium40Blue80001"
                >
              ...
              <Text
                className="md:ml-[0] ml-[338px] mt-[7px] text-black-900_a0 text-xl w-3/5 sm:w-full"
                size="txtInterRegular20Black900a0"
              >
                We are a technology company on a mission to equip students with
                relevant skills & practical exposure to help them get the best
              ...
              <div className="flex sm:flex-col flex-row sm:gap-10 items-end justify-between mt-[31px] w-3/5 md:w-full">
                <Text
                  className="text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
              ...
              <Text
                className="md:ml-[0] ml-[338px] mt-2 text-black-900_a0 text-xl w-3/5 sm:w-full"
                size="txtInterRegular20Black900a0"
              >
                We are a technology company on a mission to equip students with
                relevant skills & practical exposure to help them get the best
              ...
              <div className="flex md:flex-col flex-row md:gap-10 items-end justify-between mt-16 w-[94%] md:w-full">
                <Text
                  className="text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
              ...
              <Text
                className="md:ml-[0] ml-[334px] mt-[7px] text-black-900_a0 text-xl w-3/5 sm:w-full"
                size="txtInterRegular20Black900a0"
              >
                We are a technology company on a mission to equip students with
                relevant skills & practical exposure to help them get the best
              ...
              <div className="flex md:flex-col flex-row md:gap-10 items-end justify-between ml-0.5 md:ml-[0] mt-[65px] w-[76%] md:w-full">
                <Text
                  className="text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
              ...
              <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between ml-0.5 md:ml-[0] mt-[85px] w-[90%] md:w-full">
                <Text
                  className="text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
              ...
              <div className="flex sm:flex-col flex-row sm:gap-10 items-end justify-between ml-0.5 md:ml-[0] mt-[61px] w-[55%] md:w-full">
                <Text
                  className="text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
          ...
          <div className="flex md:flex-col flex-row font-inter md:gap-5 items-start justify-start md:ml-[0] ml-[63px] mt-[116px] md:px-5 w-[86%] md:w-full">
            ...
            <div className="flex flex-col md:gap-10 gap-44 justify-start md:ml-[0] ml-[3px] md:mt-0 mt-[46px] w-[54%] md:w-full">
              <div className="flex flex-col items-start justify-start md:ml-[0] ml-[78px] w-[89%] md:w-full">
                <Text
                ...
                <div className="flex sm:flex-col flex-row font-lato gap-[51px] items-start justify-start mt-11 w-[77%] md:w-full">
                  <Img
                    className="h-[46px]"
                    src="images/img_mdimarkertick.svg"
                ...
                <div className="flex sm:flex-col flex-row font-lato gap-[51px] items-end justify-start mt-12 w-[88%] md:w-full">
                  <Img
                  ...
                  />
                  <Text
                    className="sm:mt-0 mt-1.5 text-4xl sm:text-[32px] md:text-[34px] text-black-900 text-center"
                    size="txtLatoRegular36"
                  >
          ...
          <div className="flex md:flex-col flex-row font-inter md:gap-10 items-center justify-between max-w-[1355px] md:ml-[0] ml-[70px] mt-[43px] md:px-5 w-full">
          ...
          <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between max-w-[1134px] ml-11 md:ml-[0] mt-[89px] md:px-5 w-full">
            <Img
          ...
          <div className="font-inter h-[154px] md:h-[161px] md:ml-[0] ml-[147px] mt-[7px] md:px-5 relative w-[71%] md:w-full">
            <Text
          ...
          <Slider
            ...
            ref={sliderRef}
            className="flex font-roboto gap-[29px] max-w-[1354px] md:ml-[0] ml-[45px] mt-[89px] md:px-5 w-full"
            items={[...Array(12)].map(() => (
          ...
          />
          <PagerIndicator
            className="flex h-3.5 justify-center md:ml-[0] ml-[659px] mt-[88px] w-[126px]"
            count={4}
          ...
          />
          <Text
            className="md:ml-[0] ml-[336px] mt-[125px] md:text-5xl text-[64px] text-blue-800 text-center"
            size="txtInterBold64Blue800"
          >
            Certificate We Offer You
          </Text>
          <Text
            className="md:ml-[0] ml-[406px] mt-[19px] text-2xl md:text-[22px] text-blue_gray-400 sm:text-xl"
          ...
          <Footer2 className="flex font-inter items-center justify-center mt-[132px] md:px-5 w-full" />
        </div>
        <div className="absolute h-[178px] md:px-5 right-[5%] top-[29%] w-[51%] md:w-full">
          <Text
            className="ml-[67px] mt-[37px] text-5xl sm:text-[38px] md:text-[44px] text-black-900 text-center"
            size="txtInterBold48Black900"
          >
            Courses Highlights
          </Text>
          <div className="absolute font-poppins h-[178px] inset-[0] justify-center m-auto w-full">
            <Text
              className="absolute bottom-[18%] left-[0] text-2xl md:text-[22px] text-blue_gray-400 sm:text-xl"
              size="txtPoppinsMedium24Bluegray400"
            >
              Lorem Ipsum is simply dummy text of the printing.
            </Text>
            <Img
              className="absolute h-[178px] inset-y-[0] my-auto right-[0]"
...
export default AngularJSpagePage;
