    ...
    <>
      <div className="bg-white-A700 flex flex-col items-center justify-start mx-auto w-full">
        <div className="flex flex-col justify-start w-full">
          ...
          <div className="bg-white-A700 h-[632px] pl-[49px] md:px-5 relative w-full">
            <div className="absolute h-[632px] inset-y-[0] my-auto right-[0] w-[61%] md:w-full">
              <div className="absolute backdrop-opacity-[0.5] bg-orange-200_08 blur-[400.00px] bottom-[0] h-[141px] left-[15%] rounded-[111px] w-[26%]"></div>
              <Img
                className="absolute h-[632px] inset-y-[0] my-auto object-cover right-[0] rounded-[100px]"
                src="images/img_rectangle17.png"
                alt="rectangleSeventeen"
              />
              <div className="absolute h-[632px] inset-[0] justify-center m-auto w-full">
                <Img
                  className="h-[632px] m-auto object-cover rounded-[100px] w-full"
                  src="images/img_vector2_632x869.png"
                  alt="vectorTwo"
                />
                <Img
                  className="absolute h-14 left-[6%] top-[9%]"
                  src="images/img_cursor.svg"
                  alt="cursor"
                />
              </div>
            </div>
            <div className="absolute bottom-[31%] flex flex-col font-plusjakartasans items-center justify-start left-[8%] w-[48%]">
              <div className="flex flex-col gap-8 justify-start w-full">
                <Line className="bg-yellow-700_01 h-[5px] md:ml-[0] ml-[451px] w-[35%]" />
                <Text
                  className="leading-[32.00px] mr-3 text-gray-900_13 text-justify text-lg w-[99%] sm:w-full"
                  size="txtPlusJakartaSansRomanRegular18"
                >
                  Lorem ipsum dolor sit amet consectetur. Proin amet ac nunc
                  porta volutpat semper donec eget. Bibendum gravida sagittis
                  tortor eu sit. Tempor molestie eget sit lorem.
                </Text>
              </div>
            </div>
            <Button
              className="bottom-[16%] cursor-pointer flex items-center justify-center left-[8%] mb-[102px] min-w-[211px] rounded-[30px]"
              leftIcon={
                <Img
            ...
            >
              <div className="capitalize font-inter font-medium text-base text-left">
                Watch Video
              </div>
            </Button>
            <Text
              className="absolute capitalize leading-[86.00px] left-[8%] md:text-5xl text-[64px] text-gray-900_12 top-[24%] w-[52%] sm:w-full"
          ...
          <Text
            className="md:ml-[0] ml-[645px] mt-20 text-5xl sm:text-[38px] md:text-[44px] text-blue_gray-900_05 text-center"
          ...
          <div className="flex flex-col font-inter md:gap-10 gap-[81px] items-center justify-start max-w-[1358px] mt-12 mx-auto md:px-5 w-full">
            <Text
          ...
          <div className="font-inter h-[543px] sm:h-[591px] md:h-[707px] max-w-[1260px] mt-[120px] mx-auto md:px-5 relative w-full">
          ...
          <div className="font-inter md:h-[1114px] h-[1120px] sm:h-[1549px] ml-0.5 md:ml-[0] mt-[119px] md:px-5 relative w-full">
          ...
          <Text
            className="ml-20 md:ml-[0] mt-[59px] sm:text-[40px] md:text-[46px] text-[50px] text-orange-300 tracking-[1.00px]"
            size="txtInterBlack50Orange300"
          >
            This is where you embark on an amazing journey!
          </Text>
          <Text
            className="md:ml-[0] ml-[390px] mt-1.5 text-2xl md:text-[22px] text-blue_gray-400 sm:text-xl"
            size="txtPoppinsMedium24Bluegray400"
          >
            Lorem Ipsum is simply dummy text of the printing.
          </Text>
          <Text
            className="md:ml-[0] ml-[524px] mt-[68px] sm:text-[35.43px] md:text-[41.43px] text-[45.43px] text-blue_gray-700 text-center tracking-[1.09px] uppercase"
            size="txtInterBold4543"
          >
            How It Works
          </Text>
          <div className="flex md:flex-col flex-row font-montserrat md:gap-10 gap-[158px] items-start justify-end md:ml-[0] ml-[273px] mt-[21px] md:px-5 w-[76%] md:w-full">
          ...
          <div className="font-montserrat md:h-[400px] h-[403px] ml-11 md:ml-[0] mt-12 md:px-5 relative w-[81%] md:w-full">
          ...
          <div className="flex md:flex-col flex-row font-montserrat md:gap-10 gap-[175px] items-start justify-start md:ml-[0] ml-[50px] mt-[53px] md:px-5 w-4/5 md:w-full">
          ...
          <div className="font-montserrat h-[406px] md:h-[446px] md:ml-[0] ml-[50px] mt-[71px] md:px-5 relative w-[81%] md:w-full">
          ...
          <div className="flex sm:flex-col flex-row sm:gap-5 items-center justify-start md:ml-[0] ml-[53px] mt-[25px] md:px-5 w-[35%] md:w-full">
            <Img
          ...
          <Text
            className="md:ml-[0] ml-[513px] mt-[81px] md:text-5xl text-[64px] text-blue_gray-700 tracking-[-0.15px]"
          ...
          <div className="flex sm:flex-col flex-row font-inter gap-[46px] items-center justify-center md:ml-[0] ml-[514px] mt-32 md:px-5 w-[30%] md:w-full">
            <Img
          ...
          <div className="flex md:flex-col flex-row font-inter md:gap-10 gap-[82px] items-center justify-start max-w-[1235px] mt-[126px] mx-auto md:px-5 w-full">
          ...
          <div className="flex flex-row font-inter gap-3.5 items-center justify-center md:ml-[0] ml-[627px] mt-[127px] md:px-5 w-[17%] md:w-full">
            <Text
          ...
          <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between max-w-[1134px] mt-[65px] mx-auto md:px-5 w-full">
            <Img
          ...
          <Text
            className="md:ml-[0] ml-[42px] mt-[90px] text-blue_gray-600 text-lg uppercase"
            size="txtPoppinsSemiBold18"
          >
            REVIEW
          </Text>
          <div className="font-inter h-[154px] md:h-[161px] md:ml-[0] ml-[42px] mt-[7px] md:px-5 relative w-[71%] md:w-full">
            <Text
          ...
          />
          <Text
            className="md:ml-[0] ml-[325px] mt-[108px] md:text-5xl text-[64px] text-blue-800 text-center"
            size="txtInterBold64Blue800"
          >
            Certificate We Offer You
          </Text>
          <Text
            className="md:ml-[0] ml-[395px] mt-[19px] text-2xl md:text-[22px] text-blue_gray-400 sm:text-xl"
            size="txtPoppinsMedium24Bluegray400"
          >
            Lorem Ipsum is simply dummy text of the printing.
          </Text>
