...
const FrontenddevelopmentpagePage = () => {
  ...
  return (
    <>
      <div className="bg-white-A700 font-inter h-[12233px] mx-auto relative w-full">
        <div className="absolute flex flex-col inset-x-[0] items-center justify-start mx-auto top-[0] w-full">
          <div className="font-lato h-[900px] md:px-5 relative w-full">
            <Header2 className="flex flex-col font-inter items-center justify-center mb-[-20px] mx-auto w-full z-[1]" />
            <div
              className="bg-cover bg-no-repeat flex flex-row h-[816px] items-center justify-start mt-auto mx-auto md:pr-10 sm:pr-5 pr-[110px] py-[110px] rounded-[10px] w-full"
              style={{ backgroundImage: "url('images/img_group601.png')" }}
            >
              <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between w-full">
                <div className="h-[595px] relative w-3/5 md:w-full">
                  <div className="backdrop-opacity-[0.5] bg-white-A700_87 blur-[500.00px] h-[372px] ml-auto mr-28 mt-[34px] rounded-[202px] w-[51%]"></div>
                  <Img
                    className="absolute h-[595px] inset-[0] justify-center m-auto object-cover w-full"
                    src="images/img_cd76799354bd78f.png"
                    alt="cd76799354bd78f"
                  />
                </div>
                <Text
                  className="md:mt-0 mt-[377px] sm:text-[40px] md:text-[46px] text-[50px] text-blue_gray-700"
                  size="txtLatoBlack50"
                >
          ...
          <div className="flex flex-col font-inter gap-7 items-center justify-start max-w-[1301px] mt-[85px] md:px-5 w-full">
            <Text
              className="md:text-3xl sm:text-[28px] text-[32px] text-blue_gray-400 text-justify w-full"
              size="txtInterRegular32"
            >
              A Frontend Developer is a skilled professional responsible for
              bringing to life the designs and concepts created by web
              designers, using programming languages such as HTML (Hypertext
              Markup Language), CSS (Cascading Style Sheets), and JavaScript.
              Their primary goal is to ensure that the user interface is
              seamless, responsive, and intuitive, enhancing the overall user
              experience.
            </Text>
            <Text
              className="md:text-3xl sm:text-[28px] text-[32px] text-blue_gray-400 text-justify w-full"
              size="txtInterRegular32"
            >
              HTML forms the backbone of frontend development, providing the
              structure and content of a web page. It defines the elements and
              their arrangement on the page, such as headings, paragraphs,
              images, buttons, and forms, enabling proper organization and
              presentation of data.
            </Text>
          </div>
          <div className="flex flex-col font-inter md:gap-10 gap-[117px] items-center justify-start max-w-[1373px] mt-[87px] md:px-5 w-full">
          ...
          <div className="bg-blue_gray-700 flex font-inter md:h-44 h-[110px] justify-end mt-[117px] p-[21px] md:px-5 relative rounded-[20px] w-[37%] sm:w-full">
            <Text
              className="mt-auto mx-auto text-5xl sm:text-[38px] md:text-[44px] text-white-A700"
              size="txtInterMedium48"
            >
              Apply Now
            </Text>
            <Img
              className="absolute bottom-1/4 h-11 inset-x-[0] mx-auto"
              src="images/img_applynow.svg"
              alt="applynow_One"
            />
          </div>
        </div>
        <div className="absolute h-[471px] left-[8%] md:px-5 top-[26%] w-[37%] sm:w-full">
        ...
        <div className="absolute bottom-[0] flex flex-col inset-x-[0] justify-start mx-auto w-full">
          ...
          <div className="flex md:flex-col flex-row font-inter gap-[34px] items-start justify-end md:ml-[0] ml-[168px] mt-[78px] md:px-5 w-[82%] md:w-full">
            ...
            <div className="flex flex-col items-start justify-start w-[95%] md:w-full">
              <div className="flex sm:flex-col flex-row md:gap-10 items-start justify-between w-full">
                ...
                <Text
                  className="sm:mt-0 mt-0.5 sm:text-4xl md:text-[38px] text-[40px] text-light_blue-900_01 tracking-[0.80px]"
              ...
              <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between mt-[67px] w-[68%] md:w-full">
                <Text
                  className="text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
              ...
              <div className="flex sm:flex-col flex-row sm:gap-10 items-center justify-between mt-[71px] w-[51%] md:w-full">
                <Text
                  className="text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
              ...
              <Text
                className="md:ml-[0] ml-[335px] mt-2 text-black-900_a0 text-xl w-[57%] sm:w-full"
                size="txtInterRegular20Black900a0"
              >
                We are a technology company on a mission to equip students with
                relevant skills & practical exposure to help them get the best
              ...
              <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between mt-[74px] w-[88%] md:w-full">
                <Text
                  className="md:mt-0 mt-1 text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
                  Class 4.
                </Text>
                <div className="flex flex-col gap-2.5 items-start justify-start">
                  ...
                  <Text
                    className="ml-1 md:ml-[0] text-black-900_a0 text-xl w-full"
                    size="txtInterRegular20Black900a0"
                  >
              ...
              <div className="flex md:flex-col flex-row md:gap-10 items-end justify-between mt-[77px] w-[76%] md:w-full">
                <Text
                  className="text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
              ...
              <div className="flex sm:flex-col flex-row sm:gap-10 items-end justify-between ml-0.5 md:ml-[0] mt-[65px] w-[64%] md:w-full">
                <Text
                  className="text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
              ...
              <Text
                className="md:ml-[0] ml-[338px] mt-2.5 text-black-900_a0 text-xl w-[57%] sm:w-full"
                size="txtInterRegular20Black900a0"
              >
                We are a technology company on a mission to equip students with
                relevant skills & practical exposure to help them get the best
              ...
              <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between ml-0.5 md:ml-[0] mt-[50px] w-[81%] md:w-full">
                <Text
                  className="text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
              ...
              <Text
                className="md:ml-[0] ml-[331px] mt-4 text-black-900_a0 text-xl w-[57%] sm:w-full"
                size="txtInterRegular20Black900a0"
              >
                We are a technology company on a mission to equip students with
                relevant skills & practical exposure to help them get the best
              ...
              <div className="flex sm:flex-col flex-row sm:gap-10 items-end justify-between ml-0.5 md:ml-[0] mt-[18px] w-[53%] md:w-full">
                <Text
                  className="text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
              ...
              <Text
                className="md:ml-[0] ml-[338px] mt-[23px] text-black-900_a0 text-xl w-[57%] sm:w-full"
                size="txtInterRegular20Black900a0"
              >
                We are a technology company on a mission to equip students with
                relevant skills & practical exposure to help them get the best
          ...
          <div className="flex md:flex-col flex-row font-inter gap-2 items-start justify-start md:ml-[0] ml-[63px] mt-[102px] md:px-5 w-[86%] md:w-full">
            ...
            <div className="flex flex-col md:gap-10 gap-48 justify-start md:mt-0 mt-[46px] w-[53%] md:w-full">
              <div className="flex flex-col items-start justify-start md:ml-[0] ml-[73px] w-[89%] md:w-full">
                ...
                <div className="flex sm:flex-col flex-row font-lato gap-[51px] items-start justify-start mt-[39px] w-[77%] md:w-full">
                  <Img
                    className="h-[46px] sm:mt-0 mt-[5px]"
                    src="images/img_mdimarkertick.svg"
                ...
                <div className="flex sm:flex-col flex-row font-lato gap-[51px] items-center justify-start mt-12 w-[88%] md:w-full">
                  <Img
                    className="h-[46px]"
                    src="images/img_mdimarkertick.svg"
          ...
          />
          <PagerIndicator
            className="flex h-3.5 justify-center md:ml-[0] ml-[657px] mt-[83px] w-[126px]"
            count={4}
          ...
          />
          <Text
            className="md:ml-[0] ml-[338px] mt-[114px] md:text-5xl text-[64px] text-blue-800 text-center"
            size="txtInterBold64Blue800"
          >
            Certificate We Offer You
          </Text>
          <Text
            className="md:ml-[0] ml-[408px] mt-[19px] text-2xl md:text-[22px] text-blue_gray-400 sm:text-xl"
            size="txtPoppinsMedium24Bluegray400"
          >
            Lorem Ipsum is simply dummy text of the printing.
          </Text>
          <div className="bg-blue_gray-100_02 h-[574px] max-w-[1257px] md:ml-[0] ml-[93px] mr-[90px] mt-[87px] md:px-5 w-full"></div>
          <footer className="flex font-inter items-center justify-center mt-[142px] md:px-5 w-full">
...
export default FrontenddevelopmentpagePage;
