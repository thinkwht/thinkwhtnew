...
const PlacementguaranteeMernstackdevelopmentPage = () => {
          ...
          <div className="flex flex-col items-center justify-start w-full">
            ...
            <div className="bg-white-A700 md:h-[678px] h-[768px] pt-[74px] md:px-5 px-[74px] relative w-full">
              <div className="absolute bottom-[2%] md:h-[490px] h-[642px] inset-x-[0] mx-auto w-[89%] md:w-full">
                ...
                <div className="absolute flex flex-col gap-[46px] items-start justify-start left-[0] top-[0] w-[67%]">
                  <Text
                  ...
                  <div className="flex relative w-[58%] sm:w-full">
                    <Text
              ...
              />
              <Img
                className="absolute bottom-[27%] h-[65px] left-[5%] object-cover w-[9%]"
                src="images/img_reactjs100x6022346.png"
                alt="reactjs100x6022"
              />
              <div className="absolute bottom-[27%] flex sm:flex-col flex-row sm:gap-5 items-end justify-center left-[16%] w-[29%]">
                <Img
                  className="h-[76px] md:h-auto object-cover w-[44%] sm:w-full"
                  src="images/img_expressjs100x6022337.png"
                  alt="expressjs100xSixty"
                />
                <Img
                  className="h-[60px] md:h-auto mb-[5px] ml-9 sm:ml-[0] sm:mt-0 mt-[11px] object-cover w-[28%] sm:w-full"
                  src="images/img_nodejs100x6022339.png"
                  alt="nodejs100x60223"
                />
                <Img
                  className="h-[57px] md:h-auto mb-[7px] ml-7 sm:ml-[0] sm:mt-0 mt-3 object-cover w-[13%] sm:w-full"
                  src="images/img_image113.png"
                  alt="image114"
                />
              </div>
              <Button
                className="bottom-[14%] cursor-pointer flex items-center justify-center left-[5%] mb-[111px] min-w-[211px] ml-[5px] rounded-[30px]"
                leftIcon={
                  <Img
...
export default PlacementguaranteeMernstackdevelopmentPage;
