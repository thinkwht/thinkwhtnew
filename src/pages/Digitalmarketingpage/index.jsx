...
const DigitalmarketingpagePage = () => {
  ...
  return (
    <>
      <div className="bg-white-A700 font-inter h-[12380px] mx-auto relative w-full">
        <div className="absolute flex flex-col inset-x-[0] items-center justify-start mx-auto top-[0] w-full">
          <Header3 className="flex flex-col items-center justify-center md:px-5 w-full" />
          <div className="md:h-[796px] h-[805px] md:px-5 relative w-full">
            <Text
            ...
            <div
              className="absolute bg-cover bg-no-repeat flex flex-row font-lato h-max inset-[0] items-center justify-center m-auto p-[63px] md:px-10 sm:px-5 rounded-[10px] w-full"
              style={{ backgroundImage: "url('images/img_group601.png')" }}
            >
              <div className="flex md:flex-col flex-row gap-6 items-start justify-start mb-[78px] mt-10 w-[97%]">
                <div className="h-[552px] relative w-[59%] md:w-full">
                  <div className="backdrop-opacity-[0.5] bg-white-A700_87 blur-[500.00px] h-[372px] mt-[22px] mx-auto rounded-[202px] w-[55%]"></div>
                  <Img
                    className="absolute h-[552px] inset-[0] justify-center m-auto object-cover w-full"
                    src="images/img_4c8891359b7cc11.png"
                    alt="4c8891359b7ccEleven"
                  />
                </div>
                <Text
                  className="md:mt-0 mt-[365px] sm:text-[40px] md:text-[46px] text-[50px] text-blue_gray-700 w-2/5 sm:w-full"
                  size="txtLatoBlack50"
                >
          ...
          <Text
            className="mt-[90px] md:text-3xl sm:text-[28px] text-[32px] text-blue_gray-400 text-justify w-[93%] sm:w-full"
          ...
          >
            ...
            strategies and tactics designed to reach and engage potential
            customers, drive traffic, and ultimately achieve business goals.
            Digital marketing leverages the power of the internet and electronic
            devices to connect with consumers in meaningful ways.
          </Text>
          <Text
            className="mt-[57px] md:text-3xl sm:text-[28px] text-[32px] text-blue_gray-400 text-justify w-[94%] sm:w-full"
            size="txtInterRegular32"
          >
            Digital marketing offers several advantages, including its ability
            to target specific audiences, track and measure performance in
            real-time, adjust strategies on the fly, and reach a global audience
            at a relatively low cost compared to traditional marketing methods.
          </Text>
          <div className="bg-orange-200_01 flex flex-col items-center justify-start max-w-[1373px] mt-[102px] p-[217px] md:px-5 rounded-[10px] w-full">
          ...
          <div className="bg-blue-800_01 flex flex-row items-center justify-start max-w-[1358px] mt-[140px] p-7 md:px-5 shadow-bs7 w-full">
          ...
          <div className="flex flex-col items-center justify-start max-w-[1387px] mt-[83px] md:px-5 w-full">
        ...
        <div className="absolute bottom-[0] flex flex-col inset-x-[0] justify-start mx-auto w-full">
          ...
          <div className="font-inter h-[1120px] md:h-[1141px] sm:h-[1576px] mt-[146px] md:px-5 relative w-full">
          ...
          <div className="flex md:flex-col flex-row font-inter gap-[34px] items-start justify-start max-w-[1078px] md:ml-[0] ml-[168px] mt-[78px] md:px-5 w-full">
            ...
            <div className="flex md:flex-1 flex-col items-start justify-start w-[94%] md:w-full">
              ...
              <Text
                className="md:ml-[0] ml-[338px] text-black-900_a0 text-xl w-[63%] sm:w-full"
              ...
              <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between mt-[68px] w-[93%] md:w-full">
                <Text
                  className="text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
              ...
              <Text
                className="md:ml-[0] ml-[338px] mt-0.5 text-black-900_a0 text-xl w-[63%] sm:w-full"
                size="txtInterRegular20Black900a0"
              >
                We are a technology company on a mission to equip students with
                relevant skills & practical exposure to help them get the best
              ...
              <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between mt-[63px] w-full">
                <Text
                  className="md:mt-0 mt-[7px] text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
                  Class 3.
                </Text>
                <div className="flex flex-col gap-[11px] items-start justify-start">
                  ...
                  <Text
                    className="text-black-900_a0 text-xl w-[94%] sm:w-full"
                    size="txtInterRegular20Black900a0"
                  >
              ...
              <Text
                className="md:ml-[0] ml-[338px] mt-2 text-black-900_a0 text-xl w-[63%] sm:w-full"
                size="txtInterRegular20Black900a0"
              >
                We are a technology company on a mission to equip students with
                relevant skills & practical exposure to help them get the best
              ...
              <div className="flex md:flex-col flex-row md:gap-10 items-end justify-between mt-16 w-[97%] md:w-full">
                <Text
                  className="text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
              ...
              <Text
                className="md:ml-[0] ml-[334px] mt-[7px] text-black-900_a0 text-xl w-[63%] sm:w-full"
                size="txtInterRegular20Black900a0"
              >
                We are a technology company on a mission to equip students with
                relevant skills & practical exposure to help them get the best
              ...
              <div className="flex md:flex-col flex-row md:gap-10 items-end justify-between ml-0.5 md:ml-[0] mt-[65px] w-[97%] md:w-full">
                <Text
                  className="text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
              ...
              <Text
                className="md:ml-[0] ml-[338px] mt-[17px] text-black-900_a0 text-xl w-[63%] sm:w-full"
                size="txtInterRegular20Black900a0"
              >
                We are a technology company on a mission to equip students with
                relevant skills & practical exposure to help them get the best
              ...
              <div className="flex md:flex-col flex-row md:gap-10 items-end justify-between ml-0.5 md:ml-[0] mt-[75px] w-[88%] md:w-full">
                <Text
                  className="text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
              ...
              <Text
                className="md:ml-[0] ml-[338px] mt-[18px] text-black-900_a0 text-xl w-[63%] sm:w-full"
                size="txtInterRegular20Black900a0"
              >
                We are a technology company on a mission to equip students with
                relevant skills & practical exposure to help them get the best
              ...
              <div className="flex md:flex-col flex-row md:gap-10 items-end justify-between ml-0.5 md:ml-[0] mt-[50px] w-[87%] md:w-full">
                <Text
                  className="text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
                ...
                <Text
                  className="md:mt-0 mt-2.5 sm:text-4xl md:text-[38px] text-[40px] text-blue-800_01 tracking-[0.80px]"
                  size="txtInterMedium40Blue80001"
                >
              ...
              <Text
                className="md:ml-[0] ml-[338px] mt-[19px] text-black-900_a0 text-xl w-[63%] sm:w-full"
                size="txtInterRegular20Black900a0"
              >
                We are a technology company on a mission to equip students with
                relevant skills & practical exposure to help them get the best
          ...
          <div className="flex md:flex-col flex-row font-inter md:gap-10 gap-[82px] items-center justify-start md:ml-[0] ml-[63px] mt-[106px] md:px-5 w-[86%] md:w-full">
          ...
          <div className="font-inter md:h-[1255px] h-[719px] sm:h-[743px] md:ml-[0] ml-[75px] mt-[61px] md:px-5 relative w-[95%] md:w-full">
            <div className="absolute bottom-[0] flex flex-col inset-x-[0] items-center justify-start mx-auto w-full">
              <div className="flex flex-col gap-[49px] items-center justify-start w-full">
                <div className="flex flex-row gap-3.5 items-center justify-center w-[16%] md:w-full">
                  <Text
            ...
            <div className="absolute bottom-[6%] flex md:flex-col flex-row md:gap-10 items-start justify-between left-[2%] w-[87%]">
            ...
            <Img
              className="absolute h-[682px] object-cover right-[0] top-[0] w-[3%]"
              src="images/img_4799d32e64cad76_682x37.png"
              alt="4799d32e64cadSeventySix"
            />
          </div>
          <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between max-w-[1134px] ml-11 md:ml-[0] mt-[50px] md:px-5 w-full">
          ...
          />
          <PagerIndicator
            className="flex h-3.5 justify-center md:ml-[0] ml-[681px] mt-[89px] w-[126px]"
            count={4}
          ...
          />
          <Text
            className="md:ml-[0] ml-[335px] mt-[138px] md:text-5xl text-[64px] text-blue-800 text-center"
            size="txtInterBold64Blue800"
          >
            Certificate We Offer You
          </Text>
          <Text
            className="md:ml-[0] ml-[405px] mt-[19px] text-2xl md:text-[22px] text-blue_gray-400 sm:text-xl"
            size="txtPoppinsMedium24Bluegray400"
          >
            Lorem Ipsum is simply dummy text of the printing.
          </Text>
          <div className="bg-blue_gray-100_02 h-[574px] max-w-[1257px] md:ml-[0] ml-[102px] mr-[81px] mt-[79px] md:px-5 w-full"></div>
        ...
        <div className="absolute h-44 md:px-5 right-[5%] top-[29%] w-[51%] md:w-full">
          <Text
