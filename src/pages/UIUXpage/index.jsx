...
const UIUXpagePage = () => {
  ...
  return (
    <>
      <div className="bg-white-A700 font-inter h-[12267px] mx-auto relative w-full">
        <div className="absolute flex flex-col inset-x-[0] items-center justify-start mx-auto top-[0] w-full">
          <div className="font-lato h-[900px] md:px-5 relative w-full">
            <Header2 className="flex flex-col font-inter items-center justify-center mb-[-6px] mx-auto w-full z-[1]" />
            <div
              className="bg-cover bg-no-repeat md:h-[728px] h-[802px] mt-auto mx-auto pr-1.5 py-1.5 rounded-[10px] w-full"
              style={{ backgroundImage: "url('images/img_group601.png')" }}
            >
              <div className="absolute h-[728px] left-[0] top-[1%] w-[93%] md:w-full">
                <div className="absolute flex flex-col h-max inset-y-[0] items-center justify-start my-auto right-[0] w-4/5">
                  <div className="flex sm:flex-col flex-row md:gap-10 items-start justify-between w-full">
                    <div className="backdrop-opacity-[0.5] bg-white-A700_87 blur-[500.00px] h-[372px] mb-[116px] rounded-[202px] w-[39%]"></div>
                    <Text
                      className="sm:mt-0 mt-[372px] sm:text-[40px] md:text-[46px] text-[50px] text-blue_gray-700"
                      size="txtLatoBlack50"
                    >
                ...
                <Img
                  className="absolute h-[728px] inset-y-[0] left-[0] my-auto object-cover w-[67%]"
                  src="images/img_a76b6404c6296b3.png"
                  alt="a76b6404c6296bThree"
                />
              </div>
            </div>
          </div>
          <Text
            className="mt-6 text-5xl sm:text-[38px] md:text-[44px] text-blue_gray-900_05 text-center"
            size="txtInterBlack48"
          >
            About UI/UX
          </Text>
          <div className="flex flex-col font-inter gap-[25px] items-center justify-start max-w-[1329px] mt-[57px] md:px-5 w-full">
            <Text
            ...
            >
              ...
              aspects of designing digital products, websites, and applications
              that aim to enhance user satisfaction, accessibility, and overall
              usability. While they are distinct disciplines, they are closely
              interconnected and crucial for creating successful and engaging
              digital experiences.
            </Text>
            <Text
              className="md:text-3xl sm:text-[28px] text-[32px] text-blue_gray-400 text-justify w-full"
            ...
            >
              <>
                UI designers work on achieving consistency and coherence
                throughout the design, ensuring that the visual elements align
                with the brand&#39;s identity and target audience. They focus on
                elements such as hierarchy, contrast, and spacing to guide
                users&#39; attention and make the interface easily scannable.
                Additionally, UI designers are responsible for creating
                responsive designs that adapt seamlessly to different devices
                and screen sizes.
              </>
            </Text>
          </div>
          <div className="flex flex-col font-inter items-center justify-start max-w-[1387px] mt-[59px] md:px-5 w-full">
            <div className="flex flex-col md:gap-10 gap-[117px] items-center justify-start w-[99%] md:w-full">
            ...
            <Button
              className="cursor-pointer font-medium leading-[normal] min-w-[526px] sm:min-w-full mt-[106px] rounded-[20px] text-5xl sm:text-[38px] md:text-[44px] text-center"
              color="blue_gray_700"
              size="xl"
              variant="fill"
            >
        ...
        <div className="absolute bottom-[0] flex flex-col inset-x-[0] justify-start mx-auto w-full">
          ...
          <div className="font-inter h-[1139px] md:h-[1141px] sm:h-[1529px] mt-[146px] md:px-5 relative w-full">
            <div className="absolute h-[1001px] sm:h-[1383px] md:h-[995px] inset-x-[0] mx-auto top-[0] w-full">
              <div className="h-[1001px] sm:h-[1383px] md:h-[995px] m-auto w-full">
                <div className="flex flex-col md:gap-10 gap-[493px] h-full items-center justify-start m-auto w-full">
            ...
            <Img
              className="absolute bottom-[0] h-[630px] left-[0] object-cover w-[44%]"
              src="images/img_33c079b10fc6e0c.png"
              alt="33c079b10fc6e0c"
            />
          </div>
          <div className="flex md:flex-col flex-row font-inter gap-[34px] items-start justify-end md:ml-[0] ml-[168px] mt-[59px] md:px-5 w-[82%] md:w-full">
            <div className="md:h-[1781px] h-[1794px] md:mt-0 mt-2.5 relative w-[3%] md:w-full">
            ...
            <div className="flex flex-col items-start justify-start w-[95%] md:w-full">
              <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between w-[70%] md:w-full">
                <Text
              ...
              <Text
                className="md:ml-[0] ml-[338px] text-black-900_a0 text-xl w-[57%] sm:w-full"
              ...
              <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between mt-[67px] w-[81%] md:w-full">
                <Text
                  className="text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
              ...
              <Text
                className="md:ml-[0] ml-[338px] mt-0.5 text-black-900_a0 text-xl w-[57%] sm:w-full"
                size="txtInterRegular20Black900a0"
              >
                We are a technology company on a mission to equip students with
                relevant skills & practical exposure to help them get the best
              ...
              <Text
                className="md:ml-[0] ml-[338px] mt-[7px] text-black-900_a0 text-xl w-[57%] sm:w-full"
                size="txtInterRegular20Black900a0"
              >
                We are a technology company on a mission to equip students with
                relevant skills & practical exposure to help them get the best
              ...
              <div className="flex md:flex-col flex-row md:gap-10 items-end justify-between mt-[31px] w-[81%] md:w-full">
                <Text
                  className="text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
              ...
              <Text
                className="md:ml-[0] ml-[338px] mt-2 text-black-900_a0 text-xl w-[57%] sm:w-full"
                size="txtInterRegular20Black900a0"
              >
                We are a technology company on a mission to equip students with
                relevant skills & practical exposure to help them get the best
              ...
              <div className="flex sm:flex-col flex-row sm:gap-10 items-end justify-between mt-16 w-[64%] md:w-full">
                <Text
                  className="text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
              ...
              <Text
                className="md:ml-[0] ml-[334px] mt-[7px] text-black-900_a0 text-xl w-[57%] sm:w-full"
                size="txtInterRegular20Black900a0"
              >
                We are a technology company on a mission to equip students with
                relevant skills & practical exposure to help them get the best
              ...
              <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between ml-0.5 md:ml-[0] mt-[62px] w-[82%] md:w-full">
                <Text
                  className="md:mt-0 mt-[3px] text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
                  Class 6.
                </Text>
              ...
              <div className="flex md:flex-col flex-row md:gap-10 items-end justify-between ml-0.5 md:ml-[0] mt-[22px] w-[74%] md:w-full">
                <Text
                  className="text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
              ...
              <div className="flex md:flex-col flex-row md:gap-10 items-end justify-between ml-0.5 md:ml-[0] mt-[61px] w-4/5 md:w-full">
                <Text
                  className="text-5xl sm:text-[38px] md:text-[44px] text-orange-300 tracking-[0.96px]"
                  size="txtInterBold48Orange300"
                >
              ...
              <Text
                className="md:ml-[0] ml-[338px] mt-[9px] text-black-900_a0 text-xl w-[57%] sm:w-full"
                size="txtInterRegular20Black900a0"
              >
                We are a technology company on a mission to equip students with
                relevant skills & practical exposure to help them get the best
          ...
          <div className="flex md:flex-col flex-row font-inter gap-2 items-start justify-start md:ml-[0] ml-[63px] mt-[116px] md:px-5 w-[86%] md:w-full">
            ...
            <div className="flex flex-col md:gap-10 gap-48 justify-start md:mt-0 mt-[46px] w-[53%] md:w-full">
              <div className="flex flex-col items-start justify-start md:ml-[0] ml-[73px] w-[89%] md:w-full">
                ...
                <div className="flex sm:flex-col flex-row font-lato gap-[51px] items-start justify-start mt-[41px] w-[88%] md:w-full">
                  <Img
                    className="h-[46px] sm:mt-0 mt-1.5"
                    src="images/img_mdimarkertick.svg"
          ...
          <div className="flex md:flex-col flex-row font-inter md:gap-10 gap-[83px] items-center justify-end md:ml-[0] ml-[75px] mt-[49px] md:px-5 w-[95%] md:w-full">
                ...
                <div className="flex flex-col mx-2.5 relative">
                  <div className="bg-white-A700 flex flex-col items-center justify-start mx-auto p-[22px] sm:px-5 rounded-lg shadow-bs7 w-full">
                    <div className="flex flex-col gap-[17px] items-start justify-start mb-[55px] w-[96%] md:w-full">
                      <div className="flex flex-row gap-2 items-center justify-start ml-0.5 md:ml-[0] w-[37%] md:w-full">
                        <Img
          ...
          />
          <PagerIndicator
            className="flex h-3.5 justify-center md:ml-[0] ml-[664px] mt-[76px] w-[126px]"
            count={4}
          ...
          />
          <Text
            className="md:ml-[0] ml-[336px] mt-28 md:text-5xl text-[64px] text-blue-800 text-center"
        ...
        <div className="absolute h-44 md:px-5 right-[5%] top-[28%] w-[51%] md:w-full">
          <Text
