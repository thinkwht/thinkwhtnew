  ...
  return (
    <>
      <div className="bg-white-A700 font-roboto h-[13773px] mx-auto relative w-full">
        <div className="flex flex-col md:gap-10 gap-[119px] h-full items-center justify-start m-auto w-full">
          <div className="h-[10242px] sm:h-[10308px] md:h-[6382px] md:px-5 relative w-full">
            <div className="absolute h-[10240px] sm:h-[10308px] md:h-[6382px] inset-[0] justify-center m-auto w-full">
              <div className="absolute flex flex-col md:gap-10 gap-[242px] h-max inset-[0] justify-center m-auto w-full">
                          ...
                          <div className="md:h-[5471px] h-[9037px] sm:h-[9238px] m-auto w-full">
                            <div className="md:h-[5471px] h-[9037px] sm:h-[9238px] m-auto w-full">
                                                    ...
                                                    <div className="bg-blue_gray-700 md:h-[1222px] h-[1441px] relative rounded-bl-[20px] rounded-br-[20px] w-[1440px] md:w-full">
                                                      ...
                                                      <div className="flex flex-col h-full items-start justify-start ml-[120px] mt-[120px] w-[54%]">
                                                        ...
                                                        >
                                                          ...
                                                          learning experience
                                                          through its wide array
                                                          of courses, catering
                                                          to various subjects
                                                          and disciplines.
                                                        </Text>
                                                        <div className="flex sm:flex-col flex-row font-lato gap-[23px] items-center justify-start mt-[29px] w-[56%] md:w-full">
                                                          <div className="bg-orange-300 flex flex-col items-center justify-center sm:px-5 px-[39.5px] py-[18px] rounded-[15px] w-[203px]">
                                                            <Text
                                                              className="text-center text-white-A700 text-xl w-auto"
                                                              size="txtLatoBlack20WhiteA700"
                                                            >
                                                              Training
                                                            </Text>
                                                          </div>
                                    ...
                                    >
                                      <div className="flex flex-col justify-start mb-[222px] mt-[67px] w-[47%] md:w-full">
                                        <div className="flex flex-col items-start justify-start md:ml-[0] ml-[11px]">
                                          ...
                                          >
                                            Get a free councelling session from
                                            our campus
                                          </Text>
                                        </div>
                                        ...
                                        <div className="flex md:flex-col flex-row gap-[26px] items-start justify-start mb-10 mt-2.5 w-[99%] md:w-full">
                                          ...
                                          <div className="flex flex-col items-start justify-start md:mt-0 mt-[18px]">
                                            ...
                                            >
                                              ...
                                              pasture yet its express parties
                                              use. Sure last upon he same as
                              ...
                              <div className="absolute bg-gradient3  bottom-[41%] h-[421px] inset-x-[0] mx-auto sm:pl-5 pl-[25px] w-full">
                                ...
                                >
                                  ...
                                  Individuals Prefer To Learn! Upheed Can Offer
                            ...
                            <div className="absolute bottom-[30%] flex flex-col md:gap-10 gap-[378px] inset-x-[0] justify-start mx-auto w-[88%]">
                              <div className="flex flex-col gap-[22px] items-center justify-start w-full">
                                ...
                                >
                                  <>
                                    Placement guarantee ensures that upon
                                    successful completion of a program or
                                    course, you&#39;ll be placed in a job or
                                    internship relevant to your field of study,
                                    providing valuable career opportunities and
                            ...
                            <div className="flex flex-col font-inter gap-12 items-start justify-start md:ml-[0] ml-[104px] w-[567px] sm:w-full">
                              <div className="flex flex-col gap-4 items-start justify-start w-[567px] sm:w-full">
                                ...
                                >
                                  ...
                                  Viverra lacinia sed praesent pharetra quisque
                                  consectetur tellus elit. Suspendisse ultrices
                                  vitae at platea. Euismod pretium sit est
                                  etiam.
                                </Text>
                              </div>
                              ...
                              <div className="bg-white-A700 flex flex-col items-center justify-start mx-2.5 p-3 rounded-tl-[20px] rounded-tr-[20px] shadow-bs7">
                                <div className="flex flex-col gap-[23px] justify-start mb-1 w-full">
                                  <div className="flex sm:flex-col flex-row sm:gap-5 items-center justify-evenly w-full">
                                    ...
                                    >
                                      <>
                                        “Teachings of the great explore of
                                        truth, <br />
                ...
                <div className="flex flex-col font-inter md:gap-10 gap-24 justify-start md:ml-[0] ml-[93px] w-[58%] md:w-full">
                  ...
                  <div
                    ...
                    style={{
                      backgroundImage: "url('images/img_group853.svg')",
                    }}
                  >
                    <Img
            ...
            <Img
              className="absolute bottom-[0] h-[336px] object-cover right-[22%] w-[27%]"
              src="images/img_490f1e39dab1d74.png"
              alt="490f1e39dab1dSeventyFour"
            />
            <PagerIndicator
              className="absolute bottom-[7%] flex h-3.5 inset-x-[0] justify-center mx-auto w-[126px]"
              count={4}
          ...
          <div className="flex flex-col items-center justify-start w-full">
            <div className="bg-orange-200_01 flex flex-col items-center justify-start max-w-[1373px] mx-auto p-[217px] md:px-5 rounded-[10px] w-full">
            ...
            <List
              className="sm:flex-col flex-row font-inter md:gap-10 gap-[93px] grid sm:grid-cols-1 md:grid-cols-2 grid-cols-3 justify-center max-w-[1266px] mt-[88px] mx-auto md:px-5 w-full"
            ...
            <div className="flex flex-col font-inter items-center justify-start max-w-[1355px] mt-[98px] mx-auto md:px-5 w-full">
                    ...
                    >
                      ...
                      <div className="md:h-[120px] h-[122px] relative w-full">
                        ...
                        <Text
                          ...
                          size="txtInterMedium22"
                        >
                          Are there any job placement or internship
        ...
        <div className="absolute bg-black-900_3f flex flex-col h-full inset-[0] items-center justify-center m-auto p-[86px] md:px-10 sm:px-5 w-full">
          <div className="flex flex-col items-center justify-start max-w-[1266px] mb-[12633px] mt-[226px] w-full">
