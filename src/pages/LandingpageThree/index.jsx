  ...
  return (
    <>
      <div className="bg-white-A700 font-roboto h-[13773px] mx-auto relative w-full">
        <div className="absolute h-[10240px] sm:h-[10308px] md:h-[6381px] inset-x-[0] mx-auto md:px-5 top-[0] w-full">
          <div className="absolute flex flex-col md:gap-10 gap-[242px] h-max inset-[0] justify-center m-auto w-full">
            <div className="md:h-[5879px] h-[9476px] sm:h-[9548px] relative w-full">
              <div className="absolute md:h-[5879px] h-[9476px] sm:h-[9548px] inset-[0] justify-center m-auto w-full">
                <div className="flex flex-col md:gap-10 gap-[67px] h-full items-center justify-start m-auto w-full">
                  <div className="md:h-[5470px] h-[9166px] sm:h-[9238px] relative w-full">
                    <div className="absolute font-inter md:h-[5470px] h-[9037px] sm:h-[9238px] inset-[0] justify-center m-auto w-full">
                      <div className="md:h-[5470px] h-[9037px] sm:h-[9238px] m-auto w-full">
                        <div className="md:h-[5470px] h-[9037px] sm:h-[9238px] m-auto w-full">
                          <div className="flex flex-col md:gap-10 gap-[4276px] h-full justify-start m-auto w-full">
                            <div className="h-[4761px] sm:h-[4961px] md:h-[5429px] relative w-full">
                              <div className="h-[4761px] sm:h-[4961px] md:h-[5429px] m-auto w-full">
                                <div className="flex flex-col md:gap-10 gap-[478px] h-full justify-start m-auto w-full">
                                  <div className="h-[4078px] sm:h-[4278px] md:h-[5184px] relative w-full">
                                    <div className="flex flex-col md:gap-10 gap-[78px] h-full items-center justify-start m-auto w-full">
                                      <div className="h-[3553px] sm:h-[3754px] md:h-[4795px] relative w-full">
                                        <div className="h-[3553px] sm:h-[3754px] md:h-[4795px] m-auto w-full">
                                          <div className="h-[3553px] sm:h-[3754px] md:h-[4795px] m-auto w-full">
                                            <div className="absolute flex flex-col h-max inset-[0] items-center justify-center m-auto w-full">
                                              <div className="flex flex-col items-center justify-start w-full">
                                                <Header className="bg-white-A700 flex flex-col items-center justify-center shadow-bs7 w-full" />
        ...
        <div className="absolute bg-black-900_3f flex flex-col font-inter h-full inset-[0] items-center justify-center m-auto p-52 md:px-10 sm:px-5 w-full">
          <div className="flex flex-col items-center justify-start mb-[12532px] w-[68%] md:w-full">
            <div className="flex flex-col items-center justify-start w-full">
              <div className="bg-amber-100 flex flex-col items-center justify-start p-8 sm:px-5 rounded-[49px] shadow-bs11 w-full">
                <div className="md:h-[269px] h-[284px] relative w-[97%] md:w-full">
                  ...
                  <Img
                    className="absolute h-[30px] right-[4%] top-[0]"
                    src="images/img_close.svg"
                    alt="close"
                  />
                </div>
                <div className="flex flex-col items-start justify-start mt-[26px] w-[97%] md:w-full">
                  <Text
                    className="text-4xl sm:text-[32px] md:text-[34px] text-black-900"
                    size="txtInterMedium36"
                  >
                ...
                <Button
                  className="cursor-pointer font-medium leading-[normal] mb-[37px] min-w-[605px] md:min-w-full mt-[52px] rounded-[10px] text-4xl sm:text-[32px] md:text-[34px] text-center"
                  color="blue_gray_700"
                  size="xl"
                  variant="fill"
                >
